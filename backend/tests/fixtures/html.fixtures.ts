...
export const BARE_HTML = `<html><body><p>Hello</p></body></html>`;

/** Page with multiple H1s */
export const MULTI_H1_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
export const MISSING_ALT_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
export const MALFORMED_HTML = `<html><head><title>Broken</title>
  <<<<not valid>>>
